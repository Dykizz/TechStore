...
// Fetch cart quantity from database
$userId = $_SESSION['userId'];
$cartQtyQuery = "SELECT SUM(quantity) AS total_quantity FROM cartItem WHERE userId = $userId";
$cartQtyResult = $conn->query($cartQtyQuery);
$cartQty = $cartQtyResult->fetch_assoc()['total_quantity'] ?? 0;
?>
<!DOCTYPE html>
<html lang="vi">
<head>
...
<body>
                        ...
                        <div class="header-ctn">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                    ...
                                    <span>Giỏ hàng</span>
                                    <div class="qty"><?php echo $cartQty; ?></div>
                                </a>
                                <div class="cart-dropdown">
                                    <div class="cart-list">
                                        <?php
                                        $cartItemsQuery = "SELECT c.*, p.name, p.image, p.price FROM Cart c JOIN Product p ON c.product_id = p.id WHERE c.user_id = $userId";
                                                ...
                                                <div class='product-widget'>
                                                    ...
                                                    <div class='product-body'>
                                                        <h3 class='product-name'>
                                                            <a href='detail-product.php?id={$item['product_id']}'>{$item['name']}</a>
                                                        </h3>
                                    ...
                                    <div class="cart-summary">
                                        <small><?php echo $cartQty; ?> sản phẩm được chọn</small>
                                        <h5>TỔNG: <?php
                                            $totalQuery = "SELECT SUM(c.quantity * p.price) AS total_price FROM Cart c JOIN Product p ON c.product_id = p.id WHERE c.user_id = $userId";
                                            $totalResult = $conn->query($totalQuery);
                                            $totalPrice = $totalResult->fetch_assoc()['total_price'] ?? 0;
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            if (isset($_GET['error']) && $_GET['error'] === 'no_results') {
                echo '<div class="alert alert-danger">Không tìm thấy sản phẩm nào khớp với từ khóa "' . htmlspecialchars($_GET['keyword']) . '"!</div>';
            }
            ?>
            <div class="row">
                <!-- shop -->
                <div class="col-md-3 col-xs-6">
                    <div class="shop">
                        ...
                        <div class="shop-body">
                            <h3>Máy tính</h3>
                            <a href="./store-laptop.php?category=1" class="cta-btn">Mua ngay <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <!-- /shop -->
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="shop">
                        ...
                        <div class="shop-body">
                            <h3>Điện thoại</h3>
                            <a href="./store-smartphone.php?category=2" class="cta-btn">Mua ngay <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <!-- /shop -->
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="shop">
                        ...
                        <div class="shop-body">
                            <h3>Máy ảnh</h3>
                            <a href="./store-camera.php?category=3" class="cta-btn">Mua ngay <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <!-- /shop -->
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="shop">
                        ...
                        <div class="shop-body">
                            <h3>Phụ kiện</h3>
                            <a href="./store-accessories.php?category=4" class="cta-btn">Mua ngay <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <!-- /shop -->
                            ...
                            <div id="tab1" class="tab-pane active">
                                <div class="products-slick" data-nav="#slick-nav-1">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name">
                                                <a href="./detail-product-smartphone.php">Samsung Galaxy Z Flip5 512GB</a>
                                            </h3>
                                            <h4 class="product-price-index">
                                                <del class="product-old-price-index">29.990.000 VND</del>
                                        ...
                                        <div class="add-to-cart">
                                            <button class="add-to-cart-btn btn-announce"
                                                    data-product-id="1" 
                                                    data-name="Samsung Galaxy Z Flip5 512GB" 
                                                    data-price="16490000" 
                                                    data-image="./img/sanphammoi_samsung-z-lip5.png">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name">
                                                <a href="./detail-product-laptop.php">Laptop ASUS Gaming VivoBook K3605ZC-RP564W</a>
                                            </h3>
                                            <h4 class="product-price-index">
                                                <del class="product-old-price-index">25.290.000 VND</del>
                                        ...
                                        <div class="add-to-cart">
                                            <button class="add-to-cart-btn btn-announce"
                                                    data-product-id="2" 
                                                    data-name="Laptop ASUS Gaming VivoBook K3605ZC-RP564W" 
                                                    data-price="19290000" 
                                                    data-image="./img/Sanphamoi_laptopASUS.png">
                                                <i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name">
                                                <a href="./detail-product-accessories.php">Bàn phím cơ E-DRA EK375 Alpha Đen Đỏ</a>
                                            </h3>
                                            <h4 class="product-price-index">
                                        ...
                                        <div class="add-to-cart">
                                            <button class="add-to-cart-btn btn-announce"
                                                    data-product-id="3" 
                                                    data-name="Bàn phím cơ E-DRA EK375 Alpha Đen Đỏ" 
                                                    data-price="440000" 
                                                    data-image="./img/sanphammoi_banphim.png">
                                                <i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product" style="margin-bottom: 50px">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name">
                                                <a href="./detail-product-camera.php">Canon EOS R8, Mới 100% (Chính hãng Canon)</a>
                                            </h3>
                                            <h4 class="product-price-index">
                                                <del class="product-old-price-index">39.990.000 VND</del>
                                        ...
                                        <div class="add-to-cart">
                                            <button class="add-to-cart-btn btn-announce"
                                                    data-product-id="4" 
                                                    data-name="Canon EOS R8, Mới 100% (Chính hãng Canon)" 
                                                    data-price="28490000" 
                                                    data-image="./img/sanphammoi_canon.png">
                                                <i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div id="tab2" class="tab-pane fade in active">
                                <div class="products-slick" data-nav="#slick-nav-2">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name">
                                                <a href="./detail-product-smartphone.php">iPhone 15 Pro Max 256GB | Chính hãng VN/A</a>
                                            </h3>
                                            <h4 class="product-price-index">
                                                <del class="product-old-price-index">34.990.000 VND</del>
                                        ...
                                        <div class="add-to-cart">
                                            <button class="add-to-cart-btn btn-announce"
                                                    data-product-id="5" 
                                                    data-name="iPhone 15 Pro Max 256GB | Chính hãng VN/A" 
                                                    data-price="29490000" 
                                                    data-image="./img/iphone-15-pro-max_3.png">
                                                <i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product" style="margin-bottom: 50px">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name">
                                                <a href="./detail-product-laptop.php">Laptop ASUS TUF Gaming A14 FA401WV-RG061WS</a>
                                            </h3>
                                            <h4 class="product-price-index">
                                                <del class="product-old-price-index">46.990.000 VND</del>
                                        ...
                                        <div class="add-to-cart">
                                            <button class="add-to-cart-btn btn-announce"
                                                    data-product-id="6" 
                                                    data-name="Laptop ASUS TUF Gaming A14 FA401WV-RG061WS" 
                                                    data-price="44990000" 
                                                    data-image="./img/sanphambanchay_asus.png">
                                                <i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name">
                                                <a href="./detail-product-accessories.php">Tai nghe Bluetooth Apple AirPods Pro 2 2023 USB-C</a>
                                            </h3>
                                            <h4 class="product-price-index">
                                                <del class="product-old-price-index">6.190.000 VND</del>
                                        ...
                                        <div class="add-to-cart">
                                            <button class="add-to-cart-btn btn-announce"
                                                    data-product-id="7" 
                                                    data-name="Tai nghe Bluetooth Apple AirPods Pro 2 2023 USB-C" 
                                                    data-price="5790000" 
                                                    data-image="./img/apple-airpods-pro-2-usb-c_1_.png">
                                                <i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="./img/Máy ảnh Canon EOS R10 kit RF-S18-45mm F4.5-6.3 IS STM.png" alt="" />
                                            <div class="product-label">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name">
                                                <a href="./detail-product-camera.php">Máy ảnh Canon EOS R10 kit RF-S18-45mm F4.5-6.3 IS STM</a>
                                            </h3>
                                            <h4 class="product-price-index">
                                                <del class="product-old-price-index">28.330.000 VND</del>
                                        ...
                                        <div class="add-to-cart">
                                            <button class="add-to-cart-btn btn-announce"
                                                    data-product-id="8" 
                                                    data-name="Máy ảnh Canon EOS R10 kit RF-S18-45mm F4.5-6.3 IS STM" 
                                                    data-price="21900000" 
                                                    data-image="./img/Máy ảnh Canon EOS R10 kit RF-S18-45mm F4.5-6.3 IS STM.png">
                                                <i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng
                                            </button>
                                        </div>
                                    </div>
    ...
    <div class="store-filter clearfix">
        <ul class="store-pagination">
            ...
            <li><a href="./index.php"><i class="fa fa-angle-right"></i></a></li>
        </ul>
    </div>
    <!-- /store bottom filter -->
            ...
            button.addEventListener('click', async function (event) {
                ...
                try {
                    ...
                    if (data.status === "success") {
                        ...
                        cartQty.textContent = data.cartQuantity;
                    }
