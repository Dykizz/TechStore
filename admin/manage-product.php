...
<body>
    ...
    <div class="content">
        ...
        <div class="alert alert-info d-flex align-items-center">
            ...
            Tìm thấy &nbsp;
            <span class="badge badge-primary p-2"><?= $total_products ?></span>&nbsp;
            sản phẩm phù hợp với điều kiện tìm kiếm
        </div>
        <div class="row">
            <div class="col-6">
        ...
        <h4 class="mb-3 mr-1">Danh sách sản phẩm</h4>
        ...
        <div class="inner-pagination">
            <ul class="pagination">
                ...
                <?php if ($page > 1) { ?>
                    <li class="page-item">
                        <a href="?page=1&<?= $query_string ?>" class="page-link">««</a>
                    </li>
                <?php } ?>
                ...
                <?php if ($page > 1) { ?>
                    <li class="page-item">
                        <a href="?page=<?= $page - 1 ?>&<?= $query_string ?>" class="page-link">«</a>
                    </li>
                <?php } ?>
                ...
                <?php if ($page < $total_pages) { ?>
                    <li class="page-item">
                        <a href="?page=<?= $total_pages ?>&<?= $query_string ?>" class="page-link">»»</a>
                    </li>
                <?php } ?>
            </ul>
        </div>
...
<script>
  ...
  filterCategory.addEventListener("change", function () {
    ...
    window.location.href = `manage-product.php?category=${selectedCategory}`;
  });
</script>
<script>
