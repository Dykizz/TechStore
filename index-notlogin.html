  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="responsive-nav">
          ...
          <ul class="main-nav nav navbar-nav">
            <li class="active"><a href="./index-notlogin.html">Trang chủ</a></li>
            <li><a href="./store-laptop-notlogin.html">Máy tính</a></li>
            <li>
              <a href="./store-smartphone-notlogin.html">Điện thoại</a>
            </li>
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-xs-6">
            <div class="shop">
              ...
              <div class="shop-body">
                <h3>Máy tính</h3>
                <a href="./store-laptop-notlogin.html" class="cta-btn">
          ...
          <div class="col-md-3 col-xs-6">
            <div class="shop">
              ...
              <div class="shop-body">
                <h3>Điện thoại</h3>
                <a href="./store-smartphone-notlogin.html" class="cta-btn">
                  Mua ngay <i class="fa fa-arrow-circle-right"></i>
                </a>
              </div>
            </div>
          ...
          <div class="col-md-3 col-xs-6">
            <div class="shop">
              ...
              <div class="shop-body">
                <h3>Máy ảnh</h3>
                <a href="./store-camera-notlogin.html" class="cta-btn">
                  Mua ngay <i class="fa fa-arrow-circle-right"></i>
                </a>
              </div>
            </div>
          ...
          <div class="col-md-3 col-xs-6">
            <div class="shop">
              ...
              <div class="shop-body">
                <h3>Phụ kiện</h3>
                <a href="./store-accessories-notlogin.html" class="cta-btn">
                  Mua ngay <i class="fa fa-arrow-circle-right"></i>
                </a>
              </div>
            </div>
    ...
    <div class="store-filter clearfix">
      <ul class="store-pagination">
        ...
        <li><a href="index-notlogin.html">2</a></li>
        <li><a href="index-notlogin.html">3</a></li>
        <li><a href="index-notlogin.html">4</a></li>
        <li>
          <a href="index-notlogin.html"><i class="fa fa-angle-right"></i></a>
        </li>
      </ul>
    </div>
    <!-- store bottom filter -->
            ...
            <div class="col-md-3 col-xs-6">
              <div class="footer">
                ...
                <ul class="footer-links">
                  ...
                  <li><a href="./store-camera-notlogin.html">Máy ảnh</a></li>
                  <li>
                    <a href="./store-accessories-notlogin.html">Phụ kiện</a>
                  </li>
                </ul>
              </div>
            </div>
