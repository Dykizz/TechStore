                ...
                <div class="header-ctn">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="cart-dropdown">
                      ...
                      <div class="cart-btns">
                        <a href="./purchasing-history.html">Xem giỏ hàng</a>
        ...
        <div class="container">
          ...
          <div class="row">
              ...
              <div class="shiping-details">
                ...
                <div class="form-group">
                  ...
                  <div class="select-container">
                    <select class="form-control" id="saved-address">
                      ...
                      <option value="address3">
                        19, Đ. Nguyễn Hữu Thọ, Tân Hưng, Quận 7, TP.Hồ Chí Minh
                      </option>
                    </select>
                  </div>
                </div>
                <div class="input-checkbox">
                  ...
                  <label for="new-address-checkbox">
                    <span></span>
            ...
            <div class="col-md-5 order-details">
              ...
              <div class="product-list">
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <span id="product-name-1"
                          >Iphone 16 Pro Max 512GB | Chính hãng VN/A</span
                        >
                      </td>
                      <td class="text-center">
                        <span id="product-quantity-1">x1</span>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <span id="product-name-2"
                          >Tai nghe Bluetooth Apple AirPods 3 MagSafe</span
                        >
                      </td>
                      <td class="text-center">
                        <span id="product-quantity-2">x3</span>
                      </td>
                    </tr>
              ...
              <a href="./order-success.html" class="primary-btn order-submit">Đặt hàng</a>
            </div>
            <!-- /Order Details -->
          </div>
          <!-- /row -->
              ...
              <div class="col-md-3 col-xs-6">
                <div class="footer">
                  ...
                  <ul class="footer-links">
                    ...
                    <li><a href="./purchasing-history.html">Giỏ hàng</a></li>
